          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      ...
                      Container(
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: AppColors.inputBorder.withOpacity(0.5), width: 1),
                        ),
                      ),
                      Container(
                        width: 200,
              ...
              Text(
                ...
                style: AppTextStyles.heading.copyWith(fontSize: 28, height: 1.2),
              ),
              const SizedBox(height: 16),
              Text(
                'Satu sentuhan, Satu keluarga, Selalu\naman',
                textAlign: TextAlign.center,
                style: AppTextStyles.subHeading.copyWith(color: AppColors.primaryRed),
              ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text('Mulai Sekarang', style: AppTextStyles.buttonPrimary),
