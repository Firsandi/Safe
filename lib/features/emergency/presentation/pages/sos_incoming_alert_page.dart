...
class _SosIncomingAlertPageState extends State<SosIncomingAlertPage>
  ...
  void initState() {
    ...
    _profileImage = widget.sosData['profile_image'] ?? '';
  ...
  Future<void> _fetchVictimProfileImage() async {
    try {
      final victimPhone = widget.sosData['user_phone'] ?? '';
      if (victimPhone.isEmpty) return;
      ...
      if (response.statusCode == 200 && response.data != null) {
        ...
        if (contactsList != null) {
          ...
          final targetPhone = normalize(victimPhone);
